...
// Use VITE_API_URL environment variable for backend API endpoint
// In development: http://localhost:5000/api
// In production: https://api.evanio.com/api (or your backend URL)
const API_URL = import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:5000/api' : '/api');

// Ensure API_URL ends with /api if not already
const normalizedApiUrl = API_URL.endsWith('/api') ? API_URL : `${API_URL}/api`;

console.log('API URL configured:', normalizedApiUrl);
