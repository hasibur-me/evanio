      ...
      <div className="min-h-screen py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 relative overflow-hidden">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-white/20 rounded-full mb-6 backdrop-blur-sm">
                <Award className="w-5 h-5 text-yellow-400" />
                <span className="text-sm font-semibold text-white">Trusted by 300+ Companies</span>
                <Sparkles className="w-4 h-4 text-blue-400 animate-pulse" />
              </div>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 bg-gradient-to-r from-white via-blue-100 to-purple-100 bg-clip-text text-transparent">
                Customer Reviews
              </h1>
              ...
              <div className="flex items-center justify-center gap-2 mt-6">
                ...
                <span className="text-white/70">({stats?.total || reviews.length} reviews)</span>
              </div>
            </div>
          </div>
